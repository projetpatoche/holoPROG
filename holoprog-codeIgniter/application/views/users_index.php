<style>
/* css sur la page comme sa pas de soucis dans les fichiers css avc le framwork*/
...
.button a {
    background: url(<?php echo base_url(); ?>img/icone_connexion.png) 0 -112px no-repeat;
    color: #7E7E7E;
    font-size: 17px;
